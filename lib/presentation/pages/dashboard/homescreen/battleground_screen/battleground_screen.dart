              ...
              children: [
                Row(
                  ...
                  children: [
                    Column(
                      children: [
                        TextView(text: "₹1,175",fontColor: AppColors.black,fontSize: 12.sp,),
                        TextView(text: "(0.01%)",fontColor: AppColors.red,fontSize: 10.sp),
                      ],
                    ),
                    Column(
                      children: [
                        TextView(text: "CL",fontColor: AppColors.blue,fontSize: 15.sp,fontWeight: FontWeight.bold,),
                        TextView(text: "10x",fontColor: AppColors.blue,fontSize: 10.sp,fontWeight: FontWeight.bold,)
                      ],
                    )
                  ],
                ),
                Center(child: TextView(text: title,overflow: TextOverflow.ellipsis,fontColor: AppColors.black,fontSize: 12.sp,))
              ],
